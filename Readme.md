# Bem vindo ao meu Desafio Decodificador!
...
### Há uma validação de os requisitos do projeto estão sendo aplicados pelo usuário: não serão aceitas letras maiúsculas e caracteres especiais.
